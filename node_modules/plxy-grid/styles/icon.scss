...
.plx-icon--caret-bottom {
  @extend .plx-icon--caret-top;
  &:before {
    left: 0;
    bottom: -0.25em;
...
.plx-icon--arrow-bottom {
  @extend .plx-icon--arrow-top;
  &:before {
    top: 0;
    left: 0.14em;
...
.plx-icon--d-arrow-right {
  @extend .plx-icon--d-arrow-left;
  &:before,
  &:after {
    transform: rotate(135deg);
  }
