<template>
    <div id="divID" style="width: 100%; color: #1f2d3d;">
        ...
        <div id="deptBar" class="bar"></div>
        <div style="margin-top: 650px;">
            <el-row>
                <el-table :data="list" stripe border v-loading="listLoading" style="width: 100%;">
                    <el-table-column prop="deptName" min-width="100" label="部门名称"></el-table-column>
...
export default {
    ...
    methods: {
        getHourRadix() {
            ...
            getHourRadixDept(this.query)
                .then(response => {
                    this.listLoading = false;
                    this.list = response.data.data;
                    this.list.forEach((item, index) => {
                        //console.log(item)
                        this.optionBar.xAxis[0].data[index] = item.deptName;
        ...
        drawBar() {
            let bar = this.$echarts.init(document.getElementById('deptBar'));
