<template>
    <div>
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <span v-if="scope.row.content == 11"
                        >*研发和技术服务*专业技术服务</span
                    >
                    <span v-if="scope.row.content == 12"
                        >*研发和技术服务*软件开发</span
                    >
                    <span v-if="scope.row.content == 13"
                        >*设计服务*专业设计服务</span
                    >
                    <span v-if="scope.row.content == 14"
                        >*其他咨询服务*其他咨询服务</span
                    >
                    <span v-if="scope.row.content == 21"
                        >*印刷品*图片、设计图样及照片</span
                    >
                    <span v-if="scope.row.content == 22"
                        >*软件*系统软件产品</span
                    >
