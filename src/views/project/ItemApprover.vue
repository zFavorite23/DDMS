    ...
    <div>
        <div class="">
            ...
            <el-form :inline="true" :model="query">
                ...
                <el-form-item><el-button type="primary" size="medium" v-on:click="getItemApproverVosWithUserIdPage" icon="el-icon-search">搜索</el-button></el-form-item>
        ...
        <el-table :data="list" stripe border v-loading="listLoading" style="width: 100%;">
            ...
            <el-table-column label="操作" min-width="160">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="success" v-if="scope.row.check == 0" @click="handleModalYes(scope.row)">同意</el-button>
                    <el-button size="mini" type="danger" v-if="scope.row.check == 0" @click="handleModalNo(scope.row)">拒绝</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
            ...
            :total="total"
        ></el-pagination>
        <el-dialog title="项目审批" @click="dialogVisible = true" :visible.sync="dialogVisible"><span>sss</span></el-dialog>
    </div>
</template>
<script>
import { getItemApproverVosWithUserIdPage, checkItem } from '../../api/project/approver.js';
