    ...
    <div>
        <div class="">
            ...
            <el-form :inline="true" :model="query">
                ...
                <el-form-item><el-button type="primary" size="medium" v-on:click="getItemList" icon="el-icon-search">搜索</el-button></el-form-item>
        ...
        <el-table :data="list" stripe border v-loading="listLoading" style="width: 100%;">
            ...
            <el-table-column prop="userName" min-width="100" label="总协调"></el-table-column>
...
<script>
import { getPageList, deleteItem, itemMigration } from '../../api/project/item.js';
