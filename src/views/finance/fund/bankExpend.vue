<template>
    <div>
        <el-form :inline="true">
            <!-- <el-form-item><span class="tit">未经审批需填报--银行支出</span></el-form-item> -->
            <el-form-item><el-button type="primary" @click="dialogFormVisible = true" size="mini">支出录入</el-button></el-form-item>
        </el-form>
        <el-dialog title="支出录入" :visible.sync="dialogFormVisible">
        ...
        <el-table stripe border style="width: 100%;">
            ...
            <el-table-column min-width="120" label="支出类型"></el-table-column>
        </el-table>
    </div>
</template>
