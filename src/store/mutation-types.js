...
export const RECEIVE_ADMIN_DEPT = "RECEIVE_ADMIN_DEPT"; // 公司
export const RECEIVE_ADMIN_COMPANY = "RECEIVE_ADMIN_COMPANY"; // 公司
...
export const RECEIVE_ADMIN_PERMISSIONS = "RECEIVE_ADMIN_PERMISSIONS"; // 权限列表
